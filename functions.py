...
# PS: From running it, I think lambda is a single line function, i tried making it multiple lines but their was error in the first line
# I would do my research though
getDifference = lambda num1, num2: num1 - num2
sub_value = getDifference(100, 105)
print(sub_value)

arithmetics = lambda test, test1, test2: test + test1 - test2
value = arithmetics(48, 20, 60)
print(value)

#Getting used to writing functions
def military_uniform(rank, age, service_time):
    return f'You are a {rank} so respect people older especially when you are a {age} year old with not more than {service_time} years of service time'
